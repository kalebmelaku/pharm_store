...
$select = $conn->query('SELECT `payment` FROM `admission_med`');
$rs = $select->fetch_assoc();
$payStatus = @$rs['payment']
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Pharmacy | Admission</title>
...
<body x-data="{ page: 'admission', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="
        ...
        <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
            ...
            <main>
                ...
                <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                    ...
                    $sql = 'SELECT * FROM `admission_med` ORDER BY `date` DESC';
                    ...
                    if (!isset($_GET['search'])) {
                        include './includes/admission/all.php';
                    } else {
                        $pat_id = $_GET['pat_id'];
