			...
			<div id="content">
				...
				<div class="midde_cont">
					<div class="container-fluid">
						...
						<div class="pharmacy">
							<form method="post" id="insert_form" action="../../backend/cart_test.php">
							...
							<div class="cart">
								...
								<div class="elements">
									<div class="middle-cart">
										<?php
										$sql = "SELECT * FROM `cart_test` WHERE `user_id` = '$phone_user' ORDER BY `rn` DESC";
										...
										?>
												...
												<div class="element">
													<div>
														<?php
														echo "<a href='../../backend/remove_cart_test.php?rn=$id&user=$phone_user'><b>X</b></a>";
									...
									<div class="bottom-cart">
										<ul>
											...
											<div class="right-list">
												...
												<?php
												$sql = "SELECT SUM(sub_price) AS total FROM `cart_test` WHERE `user_id` = '$phone_user'";
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="payment">
						<form action="../../backend/confirm_test.php" method="GET">
							<div>
